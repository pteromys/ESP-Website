...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuasiStaticData.version'
        db.add_column('qsd_quasistaticdata', 'version',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuasiStaticData.version'
        db.delete_column('qsd_quasistaticdata', 'version')
